...
const TechnologiesSection: React.FC = () => {
  ...
  return (
    <section id="tecnologias-utilizadas" className="mb-20"> {/* Added ID for navigation */}
...
const Sobre: React.FC = () => {
  ...
  return (
    ...
    >
      {/* Hero Section com Imagem PERFEITAMENTE Centralizada */}
      <div className="w-full py-20">

        {/* Container de centralização absoluta */}
        <div className="w-full flex justify-center items-center">
          <div className="text-center">
            <div className="animate-float inline-block">
              <img
                src="https://i.imgur.com/SOKlBb2.png"
                alt="Ilustração CoreHumans"
      ...
      <div className="container mx-auto px-4 py-12">
        {/* Sobre o CoreHumans - Redesenhado */}
        <section id="sobre-corehumans" className="mb-20"> {/* Added ID for navigation */}
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <div className="space-y-6 text-lg text-gray-700 leading-relaxed">
                  <p className="text-xl">
                    O <span style={{ color: COLORS.primary, fontWeight: 'bold' }}>CoreHumans</span> é um software gerenciador de Recursos Humanos moderno e intuitivo.
                  </p>
                  <p>
                  ...
                  <p>
                    Nosso projeto nasceu da necessidade de <span style={{ color: COLORS.accent1, fontWeight: 'semibold' }}>otimizar e modernizar</span> os processos de RH, colocando as pessoas no centro da gestão.
                  </p>
                </div>
        ...
        <section id="equipe-desenvolvimento" className="mb-20"> {/* Added ID for navigation */}
              ...
              {teamMembers.map((member, index) => (
                <div
                  ...
                  style={{
                    ...
                    minHeight: '400px'  // Altura mínima para uniformidade
                  }}
                >
                  {/* Background gradient */}
                  <div
